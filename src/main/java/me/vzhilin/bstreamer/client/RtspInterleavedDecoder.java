 ...
 * </table>
 */
public class RtspInterleavedDecoder extends RtspObjectDecoder {
    /**
     ...
     */
    private static final Pattern VERSION_PATTERN = Pattern.compile("RTSP/\\d\\.\\d");
     ...
     */
    public RtspInterleavedDecoder(final int maxInitialLineLength,
    ...
    protected HttpMessage createMessage(final String[] initialLine)
        ...
        // this is a response
        if (VERSION_PATTERN.matcher(initialLine[0]).matches()) {
